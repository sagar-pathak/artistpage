        ...
        <div class="container-fluid clear-padding-lr">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
              ...
              <li <?php echo ACTIVE_ABOUT; ?>><a href="<?php echo ROOT_PATH.$_SESSION['lang']."/about"; ?>"><?php echo MENU2; ?></a></li>
              <li <?php echo ACTIVE_GALLERY; ?>><a href="<?php echo ROOT_PATH.$_SESSION['lang']."/gallery"; ?>"><?php echo MENU3; ?></a></li>
              <li <?php echo ACTIVE_VIDEOS; ?>><a href="<?php echo ROOT_PATH.$_SESSION['lang']."/videos"; ?>"><?php echo MENU4; ?></a></li>
              <li <?php echo ACTIVE_FEEDBACK; ?>><a href="<?php echo ROOT_PATH.$_SESSION['lang']."/feedback"; ?>"><?php echo MENU5; ?></a></li>
            </ul>
          </div>
        </div>
      </nav>
